# Generated by Django 2.2.7 on 2019-11-30 01:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.BigIntegerField(verbose_name='Số tiền giảm giá')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('promo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='orders.Coupon')),
            ],
            options={
                'ordering': ('-created',),
            },
